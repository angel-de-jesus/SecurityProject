                ...
                <form method="POST" action="{{ route('home.store') }}" role="form" id="inp">
                    {{ csrf_field() }}
                      ...
                      <div class="form-group" >
                        ...
                        <div class="form-group">
                            <textarea name="coment" id="coment" style="resize:none;"class="btn_input form-control" placeholder="Comentario" required></textarea>
                            <br>
                        </div>
                        <div class="form-group">
            ...
            <div class="carousel-inner" role="listbox">
              ...
              <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                ...
                <div class="card-body">
                  ...
                  <a class="btn btn-primary btn-xs" href="{{action('HomeController@edit', $coord->id)}}" class="card-link"><span class="glyphicon glyphicon-trash">Editar</span></a> <br> <br>
                    <form action="{{action('HomeController@destroy', $coord->id)}}" method="post">
                      {{csrf_field()}}
